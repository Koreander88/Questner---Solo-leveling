...
- If the player dies:
  - Describe the death.
- The player does not survive unless it seems logical that he be narratively saved by an NPC or the System.
...
- Only B-Rank, A-Rank, and S-Rank gates may become Red Gates.
...
- Memorable encounter.
- Leadership position within the dungeon hierarchy.
...
- Progression stages represent a general increase in capability and access to more dangerous opportunities.
- The framework is a guideline rather than a hard restriction.
...
- The gap between higher attribute ranges should feel increasingly significant.
...
- System-instance enemies may generate:
  - System Gold.
...
- Proficiencies progress through multiple levels of mastery.
- Higher proficiency levels reflect greater experience and effectiveness.
